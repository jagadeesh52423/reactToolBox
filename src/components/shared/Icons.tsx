 ...
 *
 * Professional SVG icons used across the application.
 * Using Heroicons-style design for consistency.
 */
...
export function ClipboardCheckIcon({ className = '', size = 20 }: IconProps) {
    return (
        <svg
            className={className}
            width={size}
        ...
        >
            <rect x="9" y="9" width="13" height="13" rx="2" ry="2" />
            <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
            <polyline points="12 18 14 20 18 16" />
        </svg>
    );
}
...
export function BracesIcon({ className = '', size = 16 }: IconProps) {
    return (
        <svg
            className={className}
            width={size}
...
export function BracketsIcon({ className = '', size = 16 }: IconProps) {
    return (
        <svg
            className={className}
            width={size}
...
export function ArrowsRightLeftIcon({ className = '', size = 20 }: IconProps) {
    return (
        <svg
            className={className}
            width={size}
...
export function EqualsIcon({ className = '', size = 16 }: IconProps) {
    return (
        <svg
            className={className}
            width={size}
...
export function StringTypeIcon({ className = '', size = 14 }: IconProps) {
    return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
            <path d="M9.93 13.5h4.14L15.5 17h2l-4.8-12h-1.4l-4.8 12h2l1.43-3.5zm.63-1.54L12 7.5l1.44 4.46h-2.88z"/>
        </svg>
    );
}

export function NumberTypeIcon({ className = '', size = 14 }: IconProps) {
    return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
            <path d="M4 17h2v-3h3v-2H6V9h3V7H4v10zm14-8h-3v2h3v2h-3v2h3v2h-5V7h5v2z"/>
        </svg>
    );
}

export function BooleanTypeIcon({ className = '', size = 14 }: IconProps) {
    return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export function NullTypeIcon({ className = '', size = 14 }: IconProps) {
    return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
