...
export const DiffResultDisplay: React.FC<DiffResultDisplayProps> = ({
  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col">
      <div className="flex-none flex flex-wrap items-center justify-between gap-2 mb-1.5">
        <h2 className="text-base font-bold text-gray-800 dark:text-slate-100">Differences</h2>
      ...
      {SHARE_ERROR_MESSAGES[shareStatus] && (
        <div className="flex-none mb-2 text-xs text-red-600 dark:text-red-400 bg-white dark:bg-slate-800 border border-red-200 dark:border-red-700 rounded px-2 py-1 inline-block">
          {SHARE_ERROR_MESSAGES[shareStatus]}
        </div>
      )}
      ...
      {/* Find bar */}
      <div className="flex-none mb-1.5 flex flex-wrap items-center gap-2 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg px-2 py-1.5">
      ...
      {diffResult.notice && (
        <div className="flex-none mb-2 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 text-amber-800 dark:text-amber-200 text-sm">
          {diffResult.notice}
        </div>
      )}
      ...
      <div className="flex-1 min-h-0 flex gap-2 items-stretch overflow-hidden">
        <div className="flex-1 min-w-0 h-full flex flex-col overflow-hidden">
          {viewMode === 'unified' ? (
            ...
            <div className="flex-1 min-h-0 flex flex-col lg:flex-row gap-4 border dark:border-slate-700 rounded-lg overflow-hidden shadow-sm">
              {/* Left Side */}
              <div className="w-full lg:w-1/2 flex-1 min-h-0 flex flex-col border-r dark:border-slate-700">
                <div className="flex-none bg-gradient-to-r from-gray-100 to-gray-200 dark:from-slate-700 dark:to-slate-600 p-3 font-semibold border-b dark:border-slate-600 text-gray-800 dark:text-slate-100 flex items-center gap-2">
              ...
              {/* Right Side */}
              <div className="w-full lg:w-1/2 flex-1 min-h-0 flex flex-col">
                <div className="flex-none bg-gradient-to-r from-gray-100 to-gray-200 dark:from-slate-700 dark:to-slate-600 p-3 font-semibold border-b dark:border-slate-600 text-gray-800 dark:text-slate-100 flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
      ...
      {/* Legend */}
      <div className="flex-none mt-1.5 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg px-3 py-1">
        <div className="flex flex-wrap gap-x-4 gap-y-1">
          <div className="flex items-center gap-1.5">
            <div className="w-3.5 h-3.5 bg-red-100 dark:bg-red-900/40 border border-red-300 dark:border-red-700 rounded"></div>
            <span className="text-xs font-medium text-gray-700 dark:text-slate-300">Removed</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-3.5 h-3.5 bg-green-100 dark:bg-green-900/40 border border-green-300 dark:border-green-700 rounded"></div>
            <span className="text-xs font-medium text-gray-700 dark:text-slate-300">Added</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-3.5 h-3.5 bg-yellow-100 dark:bg-yellow-900/40 border border-yellow-300 dark:border-yellow-700 rounded"></div>
            <span className="text-xs font-medium text-gray-700 dark:text-slate-300">Modified</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-3.5 h-3.5 bg-yellow-300 dark:bg-yellow-600 border border-yellow-400 dark:border-yellow-500 rounded"></div>
            <span className="text-xs font-medium text-gray-700 dark:text-slate-300">Word-level changes</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-3.5 h-3.5 bg-indigo-100 dark:bg-indigo-900/40 border border-indigo-300 dark:border-indigo-700 rounded"></div>
            <span className="text-xs font-medium text-gray-700 dark:text-slate-300">Moved</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-3.5 h-3.5 bg-orange-200 dark:bg-orange-700/60 border border-orange-300 dark:border-orange-600 rounded"></div>
            <span className="text-xs font-medium text-gray-700 dark:text-slate-300">Search match</span>
          </div>
        </div>
      </div>
    </div>
